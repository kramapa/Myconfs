...
{
	return gulp.src('./site/mybootstrap/less/style.less')				// use style.less as input
...
{
	livereload.listen();
	gulp.watch(['./site/mybootstrap/less/*.less', './site/mybootstrap/custom-bootstrap/less/*.less'], ['less']);
